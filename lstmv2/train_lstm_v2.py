...
from sgan.data.loader_lstm import data_loader
from sgan.losses_lstm import l2_loss
from sgan.losses_lstm import displacement_error, final_displacement_error

from sgan.models_lstm_v2 import My_Net_V2
        ...
        for batch in train_loader:
            ...
            if t > 0 and t % args.checkpoint_every == 0:
                ...
                metrics_val = check_accuracy(
                    args, val_loader, lstm, is_train=False
                )
                logger.info('Checking stats on train ...')
                metrics_train = check_accuracy(
                    args, train_loader, lstm, limit=True, is_train=True
                )
