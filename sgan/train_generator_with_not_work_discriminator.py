...
writer = SummaryWriter('run/exp14')
...
def main(args):
    ...
    scheduler_g = optim.lr_scheduler.StepLR(optimizer_g, step_size=100, gamma=0.5, last_epoch=(epoch if epoch != 0 else -1))
    scheduler_d = optim.lr_scheduler.StepLR(optimizer_d, step_size=100, gamma=0.5, last_epoch=(epoch if epoch != 0 else -1))
        ...
        for batch in train_loader:
            ...
            if t > 0 and t % args.checkpoint_every == 0:
                ...
                metrics_val = check_accuracy(
                    args, val_loader, generator, discriminator, d_loss_fn, is_train=False
                )
                logger.info('Checking stats on train ...')
                metrics_train = check_accuracy(
                    args, train_loader, generator, discriminator, d_loss_fn, limit=True, is_train=True
                )

                # add_accuracy_to_summary(metrics_train, metrics_val)
...
def check_accuracy(
    args, loader, generator, discriminator, d_loss_fn, limit=False, is_train=False
):
    d_losses = []
    metrics = {}
    ...
    if is_train:
        ...
        writer.add_scalar('train_ade_l', metrics['ade_l'], global_step=t)
        writer.add_scalar('train_fde_l', metrics['fde_l'], global_step=t)
        writer.add_scalar('train_ade_nl', metrics['ade_nl'], global_step=t)
        writer.add_scalar('train_fde_nl', metrics['fde_nl'], global_step=t)
    else:
        ...
        writer.add_scalar('val_ade_l', metrics['ade_l'], global_step=t)
        writer.add_scalar('val_fde_l', metrics['fde_l'], global_step=t)
        writer.add_scalar('val_ade_nl', metrics['ade_nl'], global_step=t)
        writer.add_scalar('val_fde_nl', metrics['fde_nl'], global_step=t)

    generator.train()
    return metrics


# def add_accuracy_to_summary(metrics_train, metrics_val):
#     writer.add_scalars('d_loss', {'train': metrics_train['d_loss'], 'val': metrics_val['d_loss']}, global_step=t)
#     writer.add_scalars('g_l2_loss_abs', {'train': metrics_train['g_l2_loss_abs'], 'val': metrics_val['g_l2_loss_abs']}, global_step=t)
#     writer.add_scalars('g_l2_loss_rel', {'train': metrics_train['g_l2_loss_rel'], 'val': metrics_val['g_l2_loss_rel']}, global_step=t)
#     writer.add_scalars('ade', {'train': metrics_train['ade'], 'val': metrics_val['ade']}, global_step=t)
#     writer.add_scalars('fde', {'train': metrics_train['fde'], 'val': metrics_val['fde']}, global_step=t)
#     writer.add_scalars('ade_l', {'train': metrics_train['ade_l'], 'val': metrics_val['ade_l']}, global_step=t)
#     writer.add_scalars('fde_l', {'train': metrics_train['fde_l'], 'val': metrics_val['fde_l']}, global_step=t)
#     writer.add_scalars('ade_nl', {'train': metrics_train['ade_nl'], 'val': metrics_val['ade_nl']}, global_step=t)
#     writer.add_scalars('fde_nl', {'train': metrics_train['fde_nl'], 'val': metrics_val['fde_nl']}, global_step=t)
